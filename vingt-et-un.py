...
def blackjack(dealer_hand, player_hand):
        if total_in_hand(player_hand) == 21:
                ...
                print ("\nCongratulations! You got a Vingt-et-un.\n")
                play_again()
        elif total_in_hand(dealer_hand) == 21:
                print_results(dealer_hand, player_hand)         
                print ("\nSorry, you lose. The house got a Vingt-et-un.\n")
                play_again()
...
def score(dealer_hand, player_hand):
    ...
    if total_in_hand(player_hand) == 21:
        print_results(dealer_hand, player_hand)
        print ("Congratulations! You got a Vingt-et-un!\n")

    # If Computer get sum of cards as 21 you get a blackjack
    elif total_in_hand(dealer_hand) == 21:
        print_results(dealer_hand, player_hand)         
        print ("Sorry, you lose. The house got a Vingt-et-un.\n")
    ...
    #Lost because your Sum is smaller than that of dealer
        ...
        print_results(dealer_hand, player_hand)
        print("Sorry. Your score isn't higher than the house. You lose.\n")

    #Computer Lost because your Sum is smaller than that of dealer
    elif total_in_hand(player_hand) > total_in_hand(dealer_hand):
        print_results(dealer_hand, player_hand)                    
        print ("Congratulations. Your score is higher than the house. You win\n")              
...
def game():
    ...
    while choice != "q":
        ...
        if(main_choice ==1):
            ...
            print('The two players take turns throwing two dies as many times as desired and adding up')
            print('the numbers thrown on each round.')
            print()
